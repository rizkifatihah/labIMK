              ...
              <div class="col-md-12 mb-2">
  							<div class="form-body">
  								...
  								<div class="row">
  									<div class="form-group col-md-12 mb-2">
  										<label class="sr-only" for="userinput2">Nim</label>
  										<input type="text" class="form-control border-primary" placeholder="NIM" name="nim" required>
  									</div>
  								</div>
  								<div class="row">
                  ...
                  <div class="row">
  									<div class="form-group col-12 mb-2">
  										...
  										<input class="form-control border-primary" type="text" placeholder="No Telp" pattern="[0-9]" name="no_telp" required>
  									</div>
  								</div>
  								<div class="row">
  									<div class="form-group col-12 mb-2">
