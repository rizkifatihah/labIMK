            ...
            <div class="card border-grey border-lighten-3 m-0">
                <div class="card-header border-0">
                    <div class="card-title text-center">
                        <div class="p-1"><img class="img-fluid mx-auto rounded-circle" src="<?php echo base_url().$appsProfile->logo;?>" alt="logo" style="height:100px;width:100px;"></div>
                      ...
                      <?php echo $this->session->flashdata('notif'); ?>
                        <form class="form-horizontal form-simple" action="<?php echo base_url('auth/login/do_login/');?>" novalidate method="post">
                            <fieldset class="form-group position-relative has-icon-left mb-0">
                                <input type="text" name="nim" class="form-control form-control-lg" id="user-name" placeholder="Nim" onkeyup="test()" required>
